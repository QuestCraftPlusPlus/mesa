              ...
              bool use_z24uint_s8uint)
{
    ...
    * all 1's prior to a7xx.  Disable UBWC for snorm.
    */
   if (vk_format_is_snorm(format) && info->chip < 7)
      return false;
    ...
    *
    * Prior to a650, storage images must be readonly or writeonly to use UBWC.
